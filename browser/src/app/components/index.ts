...
import { MeetingAdminPageComponent } from './meeting/meeting-admin/meeting-admin-page.component';
...
export const CONTAINER_COMPONENTS = [
  ...
  MeetingAgendaContainerComponent, MeetingStatsContainerComponent, MeetingAdminPageComponent
];
