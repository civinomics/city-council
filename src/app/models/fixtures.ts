...
const feedbackDeadline = moment('2017-03-19T06:00Z');
  ...
  meetings: [
    {
      ...
      owner: 'id-doug',
      startTime: moment('2017-03-20T06:00Z'),
      endTime: moment('2017-03-20T08:00Z'),
      feedbackDeadline,
      group: null,
      status: 'open',
      items: [
    ...
    },
    {
      ...
      title: 'Regular Meeting of the Austin City Council',
      owner: 'id-doug',
      startTime: moment('2017-03-06T06:00Z'),
      endTime: moment('2017-03-06T08:00Z'),
      feedbackDeadline: moment('2017-03-20T08:00Z'),
      group: 'id-austin-cc',
      status: 'closed',
      items: [ 'id-item-6', 'id-item-7' ]
    }
